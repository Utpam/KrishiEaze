        ...
        <aside className="w-64 bg-card-light dark:bg-surface-dark border-r border-gray-200 dark:border-gray-800 hidden md:flex flex-col h-full shadow-sm z-10">
            ...
            <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                >
                    ...
                    <span className="font-medium">{t('sidebar.dashboard', 'Dashboard')}</span>
                </NavLink>
                <NavLink
                    to="/sell"
                    className={({ isActive }) => `w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive ? 'bg-primary text-white shadow-md' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-surface-dark-2'}`}
                >
                    ...
                    <span className="font-medium">{t('sidebar.myListings', 'My Listings')}</span>
                </NavLink>
                <NavLink
                    to="/orders"
                    className={({ isActive }) => `w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive ? 'bg-primary text-white shadow-md' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-surface-dark-2'}`}
                >
                    ...
                    <span className="font-medium">{t('sidebar.orders', 'Orders')}</span>
                </NavLink>
                <NavLink
                    to="/mandi"
                    className={({ isActive }) => `w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive ? 'bg-primary text-white shadow-md' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-surface-dark-2'}`}
                >
                    ...
                    <span className="font-medium">{t('sidebar.mandiPrices', 'Mandi Prices')}</span>
                </NavLink>
                <NavLink
                    to="/profile"
                    className={({ isActive }) => `w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive ? 'bg-primary text-white shadow-md' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-surface-dark-2'}`}
                >
                    ...
                    <span className="font-medium">{t('sidebar.myProfile', 'My Profile')}</span>
                </NavLink>
            </nav>
